...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  selectChatDb: (options = {}) => ipcRenderer.invoke('select-chat-db', options),
  autoResolveChatDb: () => ipcRenderer.invoke('auto-resolve-chat-db'),
  ensureChatDbAccess: (options = {}) => ipcRenderer.invoke('ensure-chat-db-access', options),
